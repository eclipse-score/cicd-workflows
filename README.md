...
| ------------------------------ | ----------------------------------------------------------------- |
| **[PR Checks](docs/workflows/on-pr.md)** | Main PR entry point: auto-detects capabilities and runs pre-commit, tests, format, copyright and lockfile checks in one job |
